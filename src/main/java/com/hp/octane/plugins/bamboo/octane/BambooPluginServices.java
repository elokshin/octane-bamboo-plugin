...
public class BambooPluginServices extends CIPluginServicesBase {
	...
	private static final String PLUGIN_KEY = "com.hpe.adm.octane.ciplugins.bamboo-ci-plugin";
	...
	public BambooPluginServices(PluginSettingsFactory settingsFactory) {
		...
		this.pluginAccessor = ComponentLocator.getComponent(PluginAccessor.class);
	}
	...
	public CIPluginInfo getPluginInfo() {
		...
		String pluginVersion = pluginAccessor.getEnabledPlugin(PLUGIN_KEY).getPluginInformation().getVersion();
